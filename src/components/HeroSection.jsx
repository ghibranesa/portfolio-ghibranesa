...
// UBAH INI: Icon disesuaikan dengan tema jaringan/telekomunikasi
import { Terminal, Network, Server, Cpu, Download, ArrowUpRight } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center relative w-full mb-4 md:mb-5">
          {/* Left Decoration: Menggunakan Network dan Terminal */}
          <OrbitingDecoration icon={Network} delay={0.15} className="left-0 sm:left-2 lg:left-16 top-2" isRevealed={isRevealed} enableAmbientMotion={enableAmbientMotion} />
          ...
          {/* Right Decoration: Menggunakan Server dan Cpu */}
          <OrbitingDecoration icon={Server} delay={0.28} className="right-0 sm:right-2 lg:right-16 top-10" isRevealed={isRevealed} enableAmbientMotion={enableAmbientMotion} />
        ...
        >
          <h2 className="text-[clamp(1.35rem,4.2vw,2.25rem)] font-bold text-black/80 tracking-tight flex items-center justify-center flex-wrap gap-2 px-2">
            Building <span className="bg-lime-400/30 px-2 rounded-md ring-1 ring-lime-500/20">Reliable</span>Engineering Solutions<span className="text-lime-500 font-extrabold -ml-1">.</span>
          </h2>
        ...
        >
          ...
          >
            Explore Projects <ArrowUpRight size={16} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
          </button>
          <a
            href="/cv.pdf"
            download
