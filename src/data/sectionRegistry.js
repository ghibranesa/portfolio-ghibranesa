...
export const SECTION_REGISTRY = [
  ...
  },
  {
    ...
    label: 'Certifications / Professional Credentials',
    elementId: 'certifications-section',
    synonyms: [
      'certifications', 'sertifikasi', 'sertifikat', 'certificate',
      'credential', 'kredensial', 'lisensi', 'license',
      'cisco', 'ccna', 'bnsp', 'blsdm', 'komdigi', 'dts',
      'sertifikasi profesi', 'professional certification',
      'pencapaian sertifikasi', 'qualified', 'certified',
    ],
  },
  {
    id: 'scroll_to_tech',
